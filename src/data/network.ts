import { capFirst, NetworkInfo, NetworkLoad } from '../lib/common/index.js';
import { exec as cexec } from 'child_process';
import fs from 'fs';
import * as si from 'systeminformation';
import { promisify } from 'util';
import { CONFIG } from '../config.js';
import { NET_INTERFACE_PATH } from '../setup.js';
import { PLATFORM_IS_WINDOWS } from '../utils.js';
import { run as runSpeedTest } from './speedTest.js'
...
export default {
  ...
  speedTest: async (printResult = false): Promise<Partial<NetworkInfo>> => {
    ...
    if (CONFIG.speed_test_from_path) {
      ...
      let speedTest = await runSpeedTest()
      result = {
        speedDown: speedTest.downloadResult.speed * 1024 * 1024, 
        speedUp: speedTest.uploadResult.speed * 1024 * 1024,
        publicIp:  speedTest.client.ip,
      }
    }
